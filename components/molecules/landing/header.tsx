  ...
  return (
    <section className="bg-white h-screen flex items-center dark:bg-gray-900">
      <div className="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-12">
        ...
        >
          <p>
            Hi there! My name is Rabih and I&lsquo;m a software developer with 2
            years of experience in the field. I specialize in developing web
            applications using modern technologies like React, Vue, and Laravel.
          </p>
        </motion.div>
      </div>
    </section>
